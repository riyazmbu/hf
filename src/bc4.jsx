...
const intradayLosers = rows
  ...
  <div className="mover-deck-panel">
    <div
      className="mover-deck-title"
      style={{ color: 'var(--bullish-green)' }}
    >
      Top Gap Up
    </div>
    <div id="gap-up">
      <AssetPanel items={movers.gainers} showPrice />
    </div>
  </div>
  ...
  <div className="mover-deck-panel">
    <div
      className="mover-deck-title"
      style={{ color: 'var(--bearish-red)' }}
    >
      Top Gap Down
    </div>
    <div id="gap-down">
      <AssetPanel items={movers.losers} showPrice />
    </div>
  </div>
  ...
  <div className="mover-deck-panel">
    ...
    <div id="intraday-gainers">
      <AssetPanel items={movers.intradayGainers} showPrice />
    </div>
  </div>
  ...
  <div className="mover-deck-panel">
    ...
    <div id="intraday-losers">
      <AssetPanel items={movers.intradayLosers} showPrice />
    </div>
  </div>
</section>
